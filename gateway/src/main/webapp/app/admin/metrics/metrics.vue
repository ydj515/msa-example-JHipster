<template>
  <div>
    <h2>
      <span id="metrics-page-heading" data-cy="metricsPageHeading">애플리케이션 메트릭스</span>
      ...
      <div class="table-responsive">
        <table class="table table-striped" aria-describedby="Jvm gc">
          <thead>
            <tr>
              <th scope="col"></th>
              <th scope="col" class="text-right">횟수</th>
              <th scope="col" class="text-right">평균</th>
              <th scope="col" class="text-right">최소</th>
              ...
              <th scope="col" class="text-right">최대</th>
            </tr>
          </thead>
          <tbody>
            <tr>
    ...
    >
      <thead>
        <tr>
          ...
          <th scope="col">횟수</th>
          <th scope="col" class="text-right">대표값(Mean)</th>
    ...
    <b-modal ref="metricsModal" size="lg">
      <template #modal-title>
        <h4 class="modal-title" id="showMetricsLabel">쓰레드 덤프</h4>
      </template>
